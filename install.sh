...
log() {
  echo -e "${GREEN}[MINI APP SHOP VPN]${NC} $1"
}
  ...
  <main>
    ...
    <section class="section light">
      ...
      <div class="plans">
        <article class="plan">
          <h3>پلن ۱ گیگ</h3>
          <p>مدت اعتبار: یک ماه</p>
          <strong>۱۶۰,۰۰۰ <small>تومان</small></strong>
          <ul>
            <li>حجم ۱ گیگابایت</li>
            <li>اتصال پایدار و سریع</li>
            <li>تحویل از طریق ربات</li>
          </ul>
          <a href="https://t.me/${BOT_USERNAME}" target="_blank" rel="noopener">خرید از ربات</a>
        </article>
        ...
        <article class="plan featured">
          ...
          <h3>پلن ۲ گیگ</h3>
          <p>مدت اعتبار: یک ماه</p>
          <strong>۳۲۰,۰۰۰ <small>تومان</small></strong>
          <ul>
            <li>حجم ۲ گیگابایت</li>
            <li>اتصال پایدار و سریع</li>
            <li>تحویل از طریق ربات</li>
          </ul>
          <a href="https://t.me/${BOT_USERNAME}" target="_blank" rel="noopener">خرید از ربات</a>
        ...
        <article class="plan">
          <h3>پلن ۳ گیگ</h3>
          <p>مدت اعتبار: یک ماه</p>
          <strong>۴۸۰,۰۰۰ <small>تومان</small></strong>
          <ul>
            <li>حجم ۳ گیگابایت</li>
            <li>اتصال پایدار و سریع</li>
            <li>تحویل از طریق ربات</li>
          </ul>
          <a href="https://t.me/${BOT_USERNAME}" target="_blank" rel="noopener">خرید از ربات</a>
...
<header class="topbar">
  ...
  <nav>
    <a href="/">خانه</a>
    <a href="/features.html">ویژگی‌ها</a>
    <a class="active" href="/plans.html">پلن‌ها</a>
    <a href="/profile.html">مشخصات من</a>
    <a href="https://t.me/${SUPPORT_USERNAME}" target="_blank">پشتیبانی</a>
  </nav>
  <a class="glass-btn tiny" href="https://t.me/${BOT_USERNAME}" target="_blank">ورود به ربات</a>
</header>
...
<section class="section">
  <div class="plans single">
    <article class="plan">
      ...
      <strong>۱۶۰,۰۰۰ <small>تومان</small></strong>
      <ul>
        <li>۱ گیگابایت حجم</li>
        <li>اتصال پایدار</li>
        <li>تحویل خودکار</li>
      </ul>
      <a href="https://t.me/${BOT_USERNAME}" target="_blank">خرید</a>
    </article>
...
<header class="topbar">
  ...
  <nav>
    <a href="/">خانه</a>
    <a class="active" href="/features.html">ویژگی‌ها</a>
    <a href="/plans.html">پلن‌ها</a>
    <a href="/profile.html">مشخصات من</a>
    <a href="https://t.me/${SUPPORT_USERNAME}" target="_blank">پشتیبانی</a>
  </nav>
...
<header class="topbar">
  ...
  <nav>
    ...
    <a href="/features.html">ویژگی‌ها</a>
    <a href="/plans.html">پلن‌ها</a>
    <a class="active" href="/profile.html">مشخصات من</a>
    <a href="https://t.me/${SUPPORT_USERNAME}" target="_blank">پشتیبانی</a>
  </nav>
  <a class="glass-btn tiny" href="https://t.me/${BOT_USERNAME}" target="_blank">ورود به ربات</a>
</header>
...
<section class="page-head">
  <p class="eyebrow">مشخصات من</p>
  <h1>اشتراک‌های خریداری‌شده</h1>
  <p>این صفحه وقتی از داخل Mini App تلگرام باز شود، مشخصات کاربر را دریافت می‌کند.</p>
</section>

<section class="section">
  <div class="profile-card" id="profileBox">
    <h3>در حال بررسی اطلاعات...</h3>
    <p>اگر اطلاعاتی نمایش داده نشد، از داخل ربات وارد وب‌اپ شوید.</p>
  </div>
</section>
...
@font-face{font-family:VazirLocal;src:local("Tahoma")}
*{box-sizing:border-box}
html{scroll-behavior:smooth}
body{margin:0;font-family:VazirLocal,Tahoma,Arial,sans-serif;background:#030712;color:#fff;overflow-x:hidden}
a{text-decoration:none;color:inherit}
.topbar{position:sticky;top:0;z-index:50;margin:14px auto 0;width:min(1160px,calc(100% - 28px));min-height:68px;padding:10px 14px;border:1px solid rgba(255,255,255,.15);border-radius:22px;background:rgba(3,7,18,.78);backdrop-filter:blur(18px);display:flex;align-items:center;justify-content:space-between;gap:14px;box-shadow:0 18px 50px rgba(0,0,0,.32)}
...
nav a{padding:10px 12px;border-radius:14px;color:#dbeafe;font-size:14px;transition:.25s}
.active,nav a:hover{background:rgba(37,99,235,.22);color:#fff}
.glass-btn,.blue-btn,.plan a{display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(255,255,255,.75);border-radius:18px;padding:14px 24px;background:rgba(255,255,255,.88);color:#07111f;font-weight:900;box-shadow:inset 0 1px 0 rgba(255,255,255,.9),0 14px 38px rgba(0,0,0,.18);transition:.25s}
.glass-btn:hover,.glass-btn:active,.blue-btn,.plan a:hover{background:#0a84ff;color:#fff;border-color:#79bdff;box-shadow:0 0 0 4px rgba(10,132,255,.18),0 18px 45px rgba(10,132,255,.35);transform:translateY(-2px)}
.tiny{padding:10px 15px;border-radius:15px;white-space:nowrap}
.hero{position:relative;isolation:isolate;min-height:680px;width:min(1180px,100%);margin:0 auto;padding:92px 22px 76px;display:grid;grid-template-columns:1.15fr .75fr .9fr;gap:24px;align-items:center}
.hero:before{content:"";position:absolute;inset:-160px -30px 0;background:radial-gradient(circle at 64% 35%,rgba(0,132,255,.45),transparent 26%),radial-gradient(circle at 35% 0,rgba(255,255,255,.12),transparent 24%),linear-gradient(180deg,#030712 0%,#061a37 68%,#030712 100%);z-index:-2}
.hero:after{content:"";position:absolute;inset:55% -20px -30px;background:radial-gradient(ellipse at center,rgba(28,148,255,.2),transparent 60%);z-index:-1}
.pill,.eyebrow{display:inline-block;color:#62c7ff;background:rgba(14,165,233,.13);border:1px solid rgba(96,199,255,.25);padding:9px 16px;border-radius:999px;font-weight:800}
.hero h1,.page-head h1{font-size:clamp(34px,5vw,66px);line-height:1.25;margin:18px 0 16px}
.hero h1 span{color:#29aaff;text-shadow:0 0 32px rgba(41,170,255,.42)}
.hero p,.page-head p{color:#cbd5e1;font-size:18px;line-height:2;max-width:620px}
.actions{display:flex;gap:12px;flex-wrap:wrap;margin-top:26px}
.shield-card{min-height:290px;display:grid;place-items:center}
.shield{width:230px;height:270px;border-radius:45% 45% 34% 34%;background:linear-gradient(145deg,rgba(255,255,255,.18),rgba(0,132,255,.32));border:1px solid rgba(147,197,253,.45);display:grid;place-items:center;font-size:68px;box-shadow:0 0 80px rgba(0,132,255,.35),inset 0 0 40px rgba(255,255,255,.08)}
.shield span{display:block;font-size:26px;color:#fff;font-weight:900}
.feature-panel,.plan,.feature-box,.profile-card{border:1px solid rgba(255,255,255,.16);border-radius:28px;background:rgba(255,255,255,.08);backdrop-filter:blur(18px);box-shadow:0 25px 70px rgba(0,0,0,.25)}
.feature-panel{padding:22px}
.feature-panel h3{font-size:26px;margin:0 0 18px}
.feature-panel h3 span{color:#29aaff}
.feature-panel div{display:grid;gap:4px;padding:14px;margin:10px 0;border-radius:18px;background:rgba(255,255,255,.08)}
small{opacity:.76}
.section{padding:72px 22px;width:min(1160px,100%);margin:0 auto}
.light{width:100%;max-width:none;background:linear-gradient(180deg,#f8fbff,#eef6ff);color:#06111f;text-align:center}
.light>.eyebrow,.light>h2,.light>.plans{max-width:1160px;margin-left:auto;margin-right:auto}
.section h2{font-size:clamp(28px,4vw,46px);margin:14px 0 34px}
.plans{display:grid;grid-template-columns:repeat(3,1fr);gap:20px;text-align:right}
.plans.single{max-width:1160px;margin:auto}
.plan{padding:28px;color:#06111f;background:#fff;position:relative;overflow:hidden}
.plan.featured{background:linear-gradient(180deg,#071d3f,#0a4a95);color:#fff;transform:translateY(-10px);box-shadow:0 26px 70px rgba(10,132,255,.3)}
.plan em{position:absolute;top:16px;left:16px;background:#38bdf8;color:#031226;padding:7px 12px;border-radius:999px;font-style:normal;font-weight:900}
.plan h3{font-size:26px;margin:12px 0}
.plan strong{display:block;font-size:34px;color:#0a84ff;margin:16px 0}
.featured strong{color:#7dd3fc}
.plan ul{padding:0;margin:18px 0;list-style:none}
.plan li{margin:10px 0}
.plan li:before{content:"✓";color:#0a84ff;font-weight:900;margin-left:8px}
.plan a{width:100%;margin-top:10px}
.page-head{padding:72px 22px 36px;width:min(1160px,100%);margin:auto;text-align:center}
.page-head p{margin:auto}
.feature-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:18px}
.feature-box{padding:28px;text-align:center;background:rgba(255,255,255,.09)}
.feature-box h3{color:#60c7ff}
.profile-card{max-width:760px;margin:auto;padding:28px;min-height:210px}
.profile-item{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);border-radius:18px;padding:16px;margin:12px 0}
footer{border-top:1px solid rgba(255,255,255,.1);padding:26px 22px;display:flex;justify-content:center;gap:20px;color:#cbd5e1;background:#020617}
@media (max-width:900px){
  .topbar{align-items:flex-start}
  .logo{font-size:22px}
  nav{order:3;width:100%;justify-content:flex-start;overflow-x:auto;flex-wrap:nowrap;padding-bottom:2px}
  nav a{white-space:nowrap;font-size:13px}
  .tiny{font-size:13px;padding:9px 12px}
  .hero{grid-template-columns:1fr;min-height:auto;padding-top:48px;text-align:right}
  .hero p{font-size:16px}
  .shield-card{min-height:210px}
  .shield{width:180px;height:210px}
  .feature-panel{margin-top:4px}
  .plans{grid-template-columns:1fr;max-width:520px}
  .plan.featured{transform:none}
  .feature-grid{grid-template-columns:1fr 1fr}
  .actions a{flex:1;min-width:150px}
  .page-head{padding-top:45px}
}
@media (max-width:520px){
  body{background:#030712}
  .topbar{width:calc(100% - 18px);margin-top:8px;border-radius:18px;padding:10px}
  .logo{font-size:20px}
  .hero{padding:36px 14px 44px}
  .hero h1{font-size:34px}
  .hero p{font-size:15px;line-height:1.9}
  .feature-panel{padding:14px;border-radius:22px}
  .feature-panel div{padding:12px}
  .section{padding:48px 14px}
  .plans{gap:14px}
  .plan{padding:22px;border-radius:22px}
  .plan strong{font-size:29px}
  .feature-grid{grid-template-columns:1fr}
  .glass-btn,.blue-btn{width:100%;padding:13px 16px}
